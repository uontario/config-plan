...
| :b: | [IDaaS](https://github.com/uontario/IDaaS)      | :id:entity `a`s `a` `S`ervice  | [stp.uof.ca](https://stp.uof.ca) | <img src="https://img.icons8.com/external-flat-geotatah/64/000000/external-identity-sensorization-of-things-flat-flat-geotatah.png" width=30 height=30 />  |
